!(function (n, r) {
  ...
  var S = x('String'),
    ...
    I = x('ArrayBuffer'),
    k = x('Function'),
    T = r.document && r.document.childNodes;
  'function' != typeof /./ &&
  ...
  function yr(n, r, t) {
    return function (e, u, o) {
      ...
      if (u != u) return (o = r(i.call(e, a, f), C)) >= 0 ? o + a : -1;
  ...
  function mr(n, r, t) {
    var e, u;
    if (((r = Fn(r, t)), tr(n))) for (e = 0, u = n.length; e < u; e++) r(n[e], e, n);
    else {
      var o = nn(n);
  ...
  function Mr(n, r, t, e) {
    return tr(n) || (n = jn(n)), ('number' != typeof t || e) && (t = 0), gr(n, r, t) >= 0;
  }
  var Er = j(function (n, r, t) {
    var e, u;
    return (
      D(r) ? (u = r) : ((r = Nn(r)), (e = r.slice(0, -1)), (r = r[r.length - 1])),
      jr(n, function (n) {
        var o = u;
        if (!o) {
  ...
  function Ir(n, r, t) {
    if (null == r || t) return tr(n) || (n = jn(n)), n[Wn(n.length - 1)];
    var e = tr(n) ? En(n) : jn(n),
      u = Y(e);
  ...
  var Tr = kr(function (n, r, t) {
      W(n, t) ? n[t].push(r) : (n[t] = [r]);
    }),
    Dr = kr(function (n, r, t) {
      n[t] = r;
    }),
  ...
  var qr = j(function (n, r) {
      var t = {},
        e = r[0];
      if (null == n) return t;
      D(e) ? (r.length > 1 && (e = Fn(e, r[1])), (r = an(n))) : ((e = Pr), (r = er(r, !1, !1)), (n = Object(n)));
  ...
  function zr(n, r, t) {
    return null == n || n.length < 1 ? (null == r || t ? void 0 : []) : null == r || t ? n[0] : Wr(n, n.length - r);
  }
  function Lr(n, r, t) {
    ...
    return (
      mr(wn(n), function (r) {
        ...
        tn.prototype[r] = function () {
          var n = [this._wrapped];
          return o.apply(n, arguments), Qr(this, t.apply(tn, n));
        };
      }),
      tn
    );
  ...
  mr(['pop', 'push', 'reverse', 'shift', 'sort', 'splice', 'unshift'], function (n) {
    ...
    mr(['concat', 'join', 'slice'], function (n) {
      ...
      tn.prototype[n] = function () {
        var n = this._wrapped;
        return null != n && (n = r.apply(n, arguments)), Qr(this, n);
      };
    });
  var Yr = Xr({
    __proto__: null,
    ...
    template: function (n, r, t) {
      ...
      var e,
        u = RegExp(
          [(r.escape || Gn).source, (r.interpolate || Gn).source, (r.evaluate || Gn).source].join('|') + '|$',
          'g'
        ),
        o = 0,
        i = "__p+='";
      ...
      var e,
        ...
        i = j(function (i) {
          if ((e && clearTimeout(e), t)) {
            var a = !e;
            (e = setTimeout(o, r)), a && (u = n.apply(this, i));
          } else e = or(o, r, this, i);
          return u;
        });
      return (
        (i.cancel = function () {
    ...
    partition: Fr,
    toArray: function (n) {
      return n ? (U(n) ? i.call(n) : S(n) ? n.match(Vr) : tr(n) ? jr(n, Tn) : jn(n)) : [];
    },
    size: function (n) {
